...
import EventDetailsModal from "../../components/timeline/EventDetailsModal"; // Import a custom modal component for displaying event details

import "./timeline.css";

function TimelineWidget({ isVertical = false }) {
